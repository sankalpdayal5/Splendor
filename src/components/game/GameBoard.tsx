        ...
        <div className="mobile-bottom-bar">
          <button
            ...
            style={{
              ...
              alignItems: 'center',
              gap: '6px',
              background: `${activePlayer.color}25`,
              border: `1.5px solid ${activePlayer.color}`,
              boxShadow: `0 0 12px ${activePlayer.color}50`,
              color: '#FFF'
            }}
          ...
          >
            ...
            />
            <span style={{ fontWeight: 800, whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden', maxWidth: '110px' }}>
              {activePlayer.name}
            </span>
            <span style={{ fontSize: '0.68rem', opacity: 0.8, textTransform: 'uppercase', fontWeight: 700, flexShrink: 0 }}>
              TURN
            </span>
          </button>
