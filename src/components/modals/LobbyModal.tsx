  ...
  const handleStartOffline = () => {
    ...
    const config: GameConfig = {
      ...
      players: Array.from({ length: playerCount }, (_, i) => ({
        name: i === 0 ? playerName || 'Player 1' : `Bot ${i}`,
      ...
      <div className="glass-panel modal-content" style={{ maxWidth: '520px' }}>
        ...
        <div style={{ display: 'flex', background: 'rgba(0,0,0,0.4)', padding: '4px', borderRadius: '10px', marginBottom: '20px' }}>
          ...
          <button
            ...
            style={{ flex: 1, border: 'none', background: activeTab === 'online' ? 'rgba(212,175,55,0.2)' : 'transparent', color: activeTab === 'online' ? '#D4AF37' : '#94A3B8' }}
